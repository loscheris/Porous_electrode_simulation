...
//	recordtime.resize(0);
	...
	double No_potentialsteps;
	No_potentialsteps = 2*fabs(theta_v-theta_i)/step_potential;
	double No_timesteps_per_potentialstep;
	...
	double change_timestep= No_timesteps_per_potentialstep/2;
