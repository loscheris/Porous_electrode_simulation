...
src/Porous\ \ TAceo\ BV.o: ../src/Porous\ \ TAceo\ BV.cpp
	...
	g++ -O3 -Wall -c -fmessage-length=0 -fopenmp -MMD -MP -MF"src/Porous  TAceo BV.d" -MT"src/Porous\ \ TAceo\ BV.d" -o "$@" "$<"
...
src/Porous\ Main.o: ../src/Porous\ Main.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: Cross G++ Compiler'
	g++ -O3 -Wall -c -fmessage-length=0 -fopenmp -MMD -MP -MF"src/Porous Main.d" -MT"src/Porous\ Main.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
