...
//|b0 c0 0 ..........0| |x0    | |d0    |
//|a0 b1 c1 0 .......0| |x1    | |d1    |
//|0 a1 b2 c2 0 .....0|*|x2    |=|d2    |
//|...................| |......| |......|
//|0...0 a(n-2) b(n-1)| |x(n-1)| |d(n-1)|
...
public:
    ...
    void Solve_TA(const vector<double> &a, const vector<double> &b, const vector<double> &c, vector<double> &x, const vector<double> &d);
    ~ ThomasAlgorithm(){};
};
